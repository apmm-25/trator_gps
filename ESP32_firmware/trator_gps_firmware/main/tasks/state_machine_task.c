...
void state_machine_task(void* pvParameters){
    ...
    GPSData test_data1 = {38.7223000, -9.1392000, 15.0, 2.0, 10}; // Example coordinates for Lisbon
    GPSData test_data2 = {38.7223008, -9.1391770, 15.2, 2.0, 10}; // Example coordinates for Lisbon, slightly different
    ...
    while(1){
        ...
        ESP_LOGI(TAG, "plant mode is %d", test);
